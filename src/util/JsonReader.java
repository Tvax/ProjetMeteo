...
public final class JsonReader {
    ...
    /**
     * Permet de recuperer un fichier JSON a partir de son URL
     * @param url URL du fichier JSON a recuperer
     ...
     * @throws JSONException si la creation du JSONObject est impossble avec le contenu de jsonText
     */
    ...
    /**
     * Permet de recuperer les objets JSON depuis l'URL
     * @param urlJson URL designant le fichier JSON a recuperer
     * @return un JSONObject du fichier JSON
     * @throws Exception si l'acces au fichier JSON de urlJson est impossible
     */
