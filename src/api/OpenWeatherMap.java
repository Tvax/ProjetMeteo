...
public class OpenWeatherMap extends Api{
    ...
    private String buildURL(){
        return new String (URL_BASE_WEATHER + "q=" + name + "&appid=" + API_KEY_WEATHER + "&units=metric");
    }
    ...
    private void setVariables(){
        ...
        this.name = new String(this.name + ", " + jsonObject.getJSONObject("sys").get("country").toString());
